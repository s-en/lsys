...
(define-syntax match-two
  (syntax-rules (u ___ quote quasiquote ? $ = and or not set! get!)
    ...
    ((match-two v u g s (sk ...) fk i) (sk ... i))
...
(define-syntax match-extract-vars
  (syntax-rules (u ___ ? $ = quote quasiquote and or not get! set!)
    ...
    ((match-extract-vars #(p ...) k i v)
     (match-extract-vars (p ...) k i v))
    ((match-extract-vars u (k ...) i v)    (k ... v))
